...
```bash
./scripts/run_learned_boundary_head_benchmark.sh replay_residual_routed_mid 1337 2000
grep "step 2000" owt_memory_s32_k4_multiscale_x15_episodic_w0p0625_replay_residualrouted_f0p1875_b0p5_r0p5_memroute_w0p01_every32_bs4_seed1337_2000.log
```

First read:

- midpoint residual-routed val loss: `2.0383` on seed `1337`
- midpoint compute: `ffn/active_fraction=0.5938`
- that beats original residual-routed at the same seed (`2.1298`) and lean at the same seed (`2.0686`)

Next step:

```bash
./scripts/run_learned_boundary_head_benchmark.sh replay_residual_routed_mid 1437 2000
./scripts/run_learned_boundary_head_benchmark.sh replay_residual_routed_mid 1537 2000
grep "step 2000" \
  owt_memory_s32_k4_multiscale_x15_episodic_w0p0625_replay_residualrouted_f0p1875_b0p5_r0p5_memroute_w0p01_every32_bs4_seed1337_2000.log \
