...
episodic_write_gate_mode = 'none'
episodic_write_fraction = 1.0
episodic_replacement_mode = 'fifo'
use_event_segmented_memory = False
use_chunked_episodic_memory = False
event_boundary_mode = 'hidden_state_novelty'
event_boundary_teacher_mode = 'hidden_state_novelty'
event_max_segments = 0
event_summary_dim = 0
event_summary_mode = 'basic'
event_write_topk = 0
event_boundary_weight = 0.0
event_boundary_head_weight = 0.0
event_boundary_use_teacher_for_writes = False
use_event_future_prediction = False
event_future_prediction_weight = 0.0
...
use_episodic_utility_learning = False
episodic_utility_learning_weight = 0.0
...
episodic_utility_max_teacher_fraction = 1.0
...
memory_replay_stale_only = False
...
model_args = dict(
    ...
    use_refinement_loop=use_refinement_loop,
    refinement_steps=refinement_steps,
    use_recurrent_state=use_recurrent_state,
    state_dim=state_dim,
    recurrent_state_weight=recurrent_state_weight,
    ...
    episodic_write_gate_mode=episodic_write_gate_mode,
    episodic_write_fraction=episodic_write_fraction,
    episodic_replacement_mode=episodic_replacement_mode,
    use_event_segmented_memory=use_event_segmented_memory,
    use_chunked_episodic_memory=use_chunked_episodic_memory,
    event_boundary_mode=event_boundary_mode,
    event_boundary_teacher_mode=event_boundary_teacher_mode,
    event_max_segments=event_max_segments,
    event_summary_dim=event_summary_dim,
    event_summary_mode=event_summary_mode,
    event_write_topk=event_write_topk,
    event_boundary_weight=event_boundary_weight,
    event_boundary_head_weight=event_boundary_head_weight,
    event_boundary_use_teacher_for_writes=event_boundary_use_teacher_for_writes,
    use_event_future_prediction=use_event_future_prediction,
    event_future_prediction_weight=event_future_prediction_weight,
    event_future_prediction_mode=event_future_prediction_mode,
    event_future_prediction_temperature=event_future_prediction_temperature,
    ...
    use_episodic_utility_learning=use_episodic_utility_learning,
    episodic_utility_learning_weight=episodic_utility_learning_weight,
    episodic_utility_top_fraction=episodic_utility_top_fraction,
    episodic_utility_teacher_mode=episodic_utility_teacher_mode,
    episodic_utility_margin_strength=episodic_utility_margin_strength,
    episodic_utility_margin_floor=episodic_utility_margin_floor,
    episodic_utility_max_teacher_fraction=episodic_utility_max_teacher_fraction,
    ...
    memory_replay_stale_only=memory_replay_stale_only,
    memory_consolidation_weight=memory_consolidation_weight,
    ...
    ffn_base_fraction=ffn_base_fraction,
    ffn_routed_fraction=ffn_routed_fraction,
